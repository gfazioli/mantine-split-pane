...
Snap points are always interpreted as the size in pixels of the pane before the resizer: the left pane in vertical mode and the top pane in horizontal mode.
